...
def _switch_spec():
    ...
    toggle_on = Action(id="turn_on", pre=[Lamp.on == False],  # noqa: E712
...
def test_dead_actions_reported():
    ...
    open_box = Action(id="open_box", pre=[Box.sealed == False],  # noqa: E712
