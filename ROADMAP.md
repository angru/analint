...
Текущее состояние: **v0.8** — полный snapshot-DSL (Entity, BusinessRule, UseCase,
Scenario, StateMachine, Effects, Events, Flow, авто-сборка Spec). 50 тестов,
два примера (ecommerce, taskboard multi-file).
